  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="lg:ml-80 flex h-[calc(100vh-64px)]">
        {/* Left Sidebar - Compact Analytics & Filters */}
          ...
          {/* <div className="p-4 border-b border-gray-100">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-blue-50 rounded-lg p-3 text-center">
                <div className="text-xl font-bold text-blue-600">{totalReports}</div>
                <div className="text-xs text-gray-600">Total Reports</div>
              </div>
              <div className="bg-green-50 rounded-lg p-3 text-center">
                <div className="text-xl font-bold text-green-600">{completedReports}</div>
                <div className="text-xs text-gray-600">Completed</div>
              </div>
              <div className="bg-orange-50 rounded-lg p-3 text-center">
                <div className="text-xl font-bold text-orange-600">{inProgressReports}</div>
                <div className="text-xs text-gray-600">In Progress</div>
              </div>
              <div className="bg-red-50 rounded-lg p-3 text-center">
                <div className="text-xl font-bold text-red-600">{pendingReports}</div>
